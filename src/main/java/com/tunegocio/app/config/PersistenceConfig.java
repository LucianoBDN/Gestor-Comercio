...
public class PersistenceConfig {
    ...
    public static synchronized EntityManagerFactory getEntityManagerFactory() {
        if (emf == null) {
            emf = Persistence.createEntityManagerFactory("gestorComercioPU", cargarCredenciales());
        }
        return emf;
    }
        ...
        try (FileInputStream input = new FileInputStream("db.properties")) {
            ...
            throw new IllegalStateException(
                    "No se encontró db.properties en la raíz del proyecto. "
                            + "Copiá db.properties.example a db.properties y completá tus credenciales locales.", e);
        }
